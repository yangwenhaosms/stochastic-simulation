...
Here we give an investigation on $V_{k}$ in Fig~\ref{fig:3}. The variance reduces as level goes high. So we can simulate less for higher levels but higher for lower levels.
\begin{figure}[htbp!]
  \centering
