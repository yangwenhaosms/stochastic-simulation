...
As our aim is to estimate the expectation $\mathbb{E}[f(S_{n, T})]$, where $n$ means discretize the time with $M^{-n}$. In this case, $M=2$ is always supposed. In fact the expectation can be rewritten as:
\begin{align}
